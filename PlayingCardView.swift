...
//        addGestureRecognizer(UIPinchGestureRecognizer(target: self, action: #selector(adjustFaceCardScale(byHandlingGestureRecognizedBy:))))
...
//    }
    ...
    private func centeredAttributedString(_ string: String, fontSize: CGFloat) -> NSAttributedString {
        ...
        font = UIFontMetrics(forTextStyle: .body).scaledFont(for: font)          //scales the font to match the accessibility slider
        let paragraphStyle = NSMutableParagraphStyle()
        paragraphStyle.alignment = .center             // centers the text
